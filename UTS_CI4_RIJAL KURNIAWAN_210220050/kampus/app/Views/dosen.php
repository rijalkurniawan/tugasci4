    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="forms-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="<?= base_url()?>dosen" class="active">
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <p></p>
              <a href="<?php echo base_url('dosen/create/') ?>" class="btn btn-md btn-success mb-3">TAMBAH DATA</a>
                ...
                <?php foreach($dosens as $key => $dosen) : ?>
                  <tr>
                    ...
                    <td class="text-center">
                      <a href="<?php echo base_url('dosen/update/'.$mahasiswa['id_dosen']) ?>" class="btn btn-sm btn-primary">EDIT</a>
                      <a href="<?php echo base_url('dosen/delete/'.$mahasiswa['id_dosen']) ?>" class="btn btn-sm btn-danger">HAPUS</a>
