    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="components-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
            <a href="<?php echo base_url('mahasiswa/create/') ?>" class="active">
  ...
  <div class="col-lg-6">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- Vertical Form -->
              <form class="row g-3" action="/mahasiswa/insert" method="post">
                <div class="col-12">
                  <label for="nama_mahasiswa" class="form-label">Nama</label>
				  <input type="hidden" name="id_mahasiswa" value="<?= $product->id_mahasiswa;?>">
                  <input type="text" name="nama_mahasiswa" value="<?= $product->nama_mahasiswa;?>" class="form-control" id="nama_mahasiswa">
                </div>
                <div class="col-12">
                  <label for="email_mahasiswa" class="form-label">Email</label>
                  <input type="text" name="email_mahasiswa" value="<?= $product->email_mahasiswa;?>" class="form-control" id="email_mahasiswa">
                </div>
                <div class="col-12">
                  <label for="nim" class="form-label">NIM</label>
                  <input type="text" name="nim" value="<?= $product->nim;?>" class="form-control" id="nim">
                </div>
                <div class="col-12">
                  <label for="jurusan" class="form-label">Jurusan</label>
                  <input type="text" name="jurusan" value="<?= $product->jurusan;?>" class="form-control" id="jurusan">
                </div>
				<div class="col-12">
                  <label for="semester" class="form-label">Semester</label>
                  <input type="text" name="semester" value="<?= $product->semester;?>" class="form-control" id="semester">
                </div>
